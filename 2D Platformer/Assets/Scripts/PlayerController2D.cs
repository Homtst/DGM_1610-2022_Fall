...
public class PlayerController2D : MonoBehaviour
{
    ...
    // Fixed Update is called a fixed or set number of frames. This works best physics based movement
    void FixedUpdate()
    {
        ...
        // If the player is moving rigth but facing left flip the player right
    ...
    void FlipPlayer()
    {
        ...
        Vector3 scaler= transform.localScale; // Local varible that stores localscale value
